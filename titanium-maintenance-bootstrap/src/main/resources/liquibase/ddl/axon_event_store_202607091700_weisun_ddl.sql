...
--rollback DROP TABLE IF EXISTS domain_event_entry;
...
--rollback DROP TABLE IF EXISTS snapshot_event_entry;
...
--rollback DROP TABLE IF EXISTS token_entry;
...
--rollback DROP TABLE IF EXISTS saga_entry;
...
--rollback DROP TABLE IF EXISTS association_value_entry;
