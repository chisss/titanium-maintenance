...
import com.titanium.billing.api.request.retroactive.PostRetroactivePeriodAdjustmentRequest;
import com.titanium.billing.api.request.retroactive.PostRetroactivePeriodAdjustmentRequest.PeriodAdjustmentRequest;
...
public class BillingRetroactivePeriodAdjustmentAdapter implements BillingRetroactivePeriodAdjustmentPort {
    ...
    private MaintenanceRemoteCallException remoteError(String message) {
        return new MaintenanceRemoteCallException(message, MaintenanceErrorCode.MAINTENANCE_BILLING_RETROACTIVE_ADJUSTMENT_ERROR);
    }
}
