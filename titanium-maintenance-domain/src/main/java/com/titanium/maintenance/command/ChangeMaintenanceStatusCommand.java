...
public class ChangeMaintenanceStatusCommand {
    ...
    public static ChangeMaintenanceStatusCommand of(String maintenanceId, MaintenanceStatus newStatus,
        ...
        return ChangeMaintenanceStatusCommand.builder().id(MaintenanceId.of(maintenanceId)).newStatus(newStatus)
                .changeReason(changeReason).changedBy(changedBy).build();
    }
}
