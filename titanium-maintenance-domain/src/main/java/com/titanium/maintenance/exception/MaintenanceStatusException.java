 ...
 * 保全状态流转异常
 * <p>
 * 当保全聚合根在非法状态下执行操作或发生非法状态流转时抛出，
 * 如对已完成/已拒绝的保全变更状态、或删除非待处理状态的保全。
 * 继承 metadata 统一异常体系的 {@link IllegalStateTransitionException}，
 * 携带统一错误码 {@code ILLEGAL_STATE_TRANSITION} 及保全ID、源状态、目标状态等上下文。
 * </p>
 *
 * @author wei.sun
 * @since 2026/6/23
...
public class MaintenanceStatusException extends IllegalStateTransitionException {
    ...
    public MaintenanceStatusException(String maintenanceId, String fromStatus, String toStatus) {
        super(AGGREGATE_TYPE, maintenanceId, fromStatus, toStatus);
    }
    ...
    public MaintenanceStatusException(String maintenanceId, String fromStatus, String toStatus, String reason) {
        super(AGGREGATE_TYPE, maintenanceId, fromStatus, toStatus, reason);
    }
}
